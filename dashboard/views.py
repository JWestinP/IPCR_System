...
def dashboard_admin_superadmin (request):
    current_user = request.user
    ...
    return render(request, ('dashboard/admin_superadmin_dashboard.html'), context)

class HomeView2(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'dashboard/admin_superadmin_dashboard.html')
